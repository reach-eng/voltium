...
void main() {
  testWidgets('Golden Test - PickupVehicleSearchSheet', (WidgetTester tester) async {
    ...
    await expectLater(
      ...
      matchesGoldenFile('goldens/pickup_vehicle_search_sheet_golden_test_default.png'),
    );
  });
}
