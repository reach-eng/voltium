...
void main() {
  group('FormValidators.aadhaar', () {
    test('accepts valid 12-digit Aadhaar', () {
      expect(FormValidators.aadhaar('123456789012'), isNull);
    });

    test('accepts Aadhaar with spaces', () {
      expect(FormValidators.aadhaar('1234 5678 9012'), isNull);
    });
  ...
  group('FormValidators.pan', () {
    ...
    test('rejects PAN with letters in position 6-9', () {
      ...
      expect(FormValidators.pan('ABCDEABCD'), isNotNull); // letters in digit positions
    });
