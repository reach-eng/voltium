...
class _PermissionsScreenState extends State<PermissionsScreen>
  ...
  final List<_PermissionItem> _permissions = [
    ...
    _PermissionItem(
      id: 'phone',
      name: 'Phone',
      description: 'Make phone calls from the app',
      icon: Icons.phone_outlined,
    ),
    _PermissionItem(
      id: 'call_log',
      name: 'Call Log',
      description: 'Verify support call authenticity',
    ...
    _PermissionItem(
      id: 'mic',
      name: 'Microphone',
      description: 'Voice support and assistance',
    ...
    _PermissionItem(
      ...
      description:
          'Show critical alerts and notifications on top of other apps',
      icon: Icons.picture_in_picture_alt_outlined,
    ),
    _PermissionItem(
      id: 'device_admin',
      name: 'Device Admin',
      description: 'Company device management for security and compliance',
    ...
    for (var perm in _permissions) {
      ...
      switch (perm.id) {
        ...
        case 'display_over_apps':
          if (!mounted) return;
          perm.isEnabled = context.read<AppProvider>().canDrawOverlays;
          continue;
        case 'device_admin':
          if (!mounted) return;
  ...
  Future<void> _togglePermission(_PermissionItem item) async {
    ...
    switch (item.id) {
      ...
      case 'battery':
        ...
        return;
      case 'display_over_apps':
        await context.read<AppProvider>().requestOverlayPermission();
        return;
      case 'device_admin':
  ...
  Widget build(BuildContext context) {
    ...
    for (var p in _permissions) {
      ...
      if (p.id == 'display_over_apps')
        p.isEnabled = appProvider.canDrawOverlays;
    }
