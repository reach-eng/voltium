...
const _kRentalSafetyContent =
    'This Rental and Safety Agreement ("Agreement") governs the rental and operation of Ryd electric vehicles.\n\n1. Vehicle Inspection: You must inspect the vehicle before each ride and report any damage immediately. You are responsible for pre-existing damage not reported.\n\n2. Safe Operation: You agree to operate the vehicle in accordance with all traffic laws, wear a helmet at all times, and not operate under the influence of alcohol or drugs.\n\n3. Parking and Storage: Vehicles must be returned to designated hubs. Overnight parking is permitted only at approved locations. Improper parking may result in additional charges.\n\n4. Damage and Theft: You are liable for damage or theft during your rental period. Ryd recommends opting for damage protection plans where available.\n\n5. Speed and Usage Limits: Vehicles have speed governors and geo-fencing. Violation of usage zones or speed limits may result in penalties or account suspension.\n\n6. Accident Protocol: In case of an accident, ensure your safety first, contact emergency services if needed, and report the incident through the Ryd app within 24 hours.';

const _kRefundContent =
    'This Refund and Cancellation Policy outlines the terms for cancellations and refunds on Ryd\'s rental services.\n\n1. Rental Cancellation: You may cancel a rental booking up to 2 hours before the scheduled start time for a full refund. Cancellations within 2 hours may incur a fee of 10% of the booking amount.\n\n2. Security Deposit Refund: Security deposits are refundable after 180 days of active service, subject to the terms outlined in your rental agreement. Deductions may apply for outstanding dues, damages, or non-returned accessories.\n\n3. Top-Up Refunds: Wallet top-ups are non-refundable but remain in your Ryd wallet for future rentals. Refund requests for technical errors or duplicate transactions will be processed within 5-7 business days.\n\n4. Plan Changes: You may upgrade your rental plan at any time. Downgrades take effect at the next billing cycle. Prorated refunds are provided for unused days on annual or monthly plans.\n\n5. Service Disruptions: If Ryd is unable to provide a booked vehicle due to operational issues, you will receive a full refund or a comparable vehicle upgrade at no additional charge.';

const _kGuarantorAgreementContent =
    'This Guarantor\'s Agreement ("Agreement") is a legally binding contract between you (the "Guarantor") and Ryd, guaranteeing the obligations of the rider you are sponsoring.\n\n1. Guarantor Obligations: As a guarantor, you agree to be jointly and severally liable for all rental charges, damages, and penalties incurred by the rider during the rental period.\n\n2. Financial Responsibility: You authorize Ryd to recover any outstanding amounts from the rider\'s security deposit or wallet balance. If the balance is insufficient, you agree to pay the outstanding amount upon demand.\n\n3. Duration: This guarantor obligation remains in effect for the entire duration of the rider\'s active subscription with Ryd and for 30 days after the account is closed or terminated.\n\n4. Termination: You may request to be released as a guarantor by providing 30 days written notice. Ryd reserves the right to require the rider to provide an alternate guarantor before releasing you.\n\n5. Communication: You agree to receive communications from Ryd regarding the rider\'s account status, payment defaults, and other relevant notifications at the phone number and email address provided during registration.\n\n6. Verification: You confirm that all information provided during the guarantor registration process is accurate and complete. Ryd may verify your identity and financial standing through third-party services.';
