                  ...
                  children: [
                        ...
                        return GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color: isSelected ? const Color(0xFF2F6DDE) : Colors.white,
                              borderRadius: BorderRadius.circular(12),
                              border: Border.all(
                                color: isSelected ? const Color(0xFF2F6DDE) : const Color(0xFFE2E8F0),
                                width: 1,
                              ),
                            ),
                            child: Center(
                    ...
                    Consumer<AppProvider>(
                      builder: (context, provider, _) {
                        final currentBalance = provider.rider?.walletBalance ?? 0.0;
                        return Row(
  ...
  Widget _buildProceedButton() {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        height: 56,
        decoration: BoxDecoration(
          color: _canProceed ? const Color(0xFF2F6DDE) : const Color(0xFFE2E8F0),
          borderRadius: BorderRadius.circular(16),
          boxShadow: _canProceed
              ? [
                  BoxShadow(
                    color: const Color(0xFF2F6DDE).withOpacity(0.3),
                    blurRadius: 12,
