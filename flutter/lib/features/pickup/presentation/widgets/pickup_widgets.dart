      ...
      child: Column(
        ...
        children: [
                ...
                children: [
                  Expanded(
                    child: PhotoUploadCard(
                      ...
                      onTap: () => showImageSourceDialog(context, 'front', onUploadImage),
                    ),
                  ),
                  ...
                  Expanded(
                    child: PhotoUploadCard(
                      ...
                      onTap: () => showImageSourceDialog(context, 'back', onUploadImage),
                    ),
                  ),
                ],
              ),
                ...
                children: [
                  Expanded(
                    child: PhotoUploadCard(
                      ...
                      onTap: () => showImageSourceDialog(context, 'left', onUploadImage),
                    ),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: PhotoUploadCard(
                      ...
                      onTap: () => showImageSourceDialog(context, 'right', onUploadImage),
                    ),
                  ),
                ],
              ),
          ...
          PhotoUploadCard(
            ...
            onTap: () => showImageSourceDialog(context, 'with_vehicle', onUploadImage),
          ),
        ],
      ),
    );
