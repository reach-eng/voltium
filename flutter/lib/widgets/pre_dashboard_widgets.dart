...
class PreDashboardProfileCard extends StatelessWidget {
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  border: Border.all(
                      color: const Color(0xFFFFE4E6), width: 3),
                ),
  ...
  Widget _buildNormalProfile() {
    final String badgeText =
        kycVerified ? 'KYC VERIFIED' : 'PENDING KYC';
    final Color badgeBg = kycVerified
        ? const Color(0xFFF0FDF4)
        : const Color(0xFFFFF7ED);
    final Color badgeTextColor = kycVerified
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              shape: BoxShape.circle,
              border: Border.all(
                  color: const Color(0xFFF1F5F9), width: 4),
            ),
            child: ClipOval(
              child:
...
class PreDashboardCtaCard extends StatelessWidget {
  ...
  factory PreDashboardCtaCard.startRegistration({
    ...
    return PreDashboardCtaCard(
      ...
      description:
          'Set up your profile, verify your identity, and add a guarantor to start riding with Ryd.',
