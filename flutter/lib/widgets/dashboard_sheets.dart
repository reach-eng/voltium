        ...
        child: Column(
          ...
          children: [
            ...
            const CircleAvatar(
              ...
              child:
                  Icon(Icons.person, size: 48, color: Color(0xFF94A3B8)),
            ),
...
void showSubscriptionSheet(
    BuildContext context, RiderModel rider, {VoidCallback? onRequestPlanChange}) {
  showModalBottomSheet(
    context: context,
    isScrollControlled: true,
    backgroundColor: Colors.transparent,
    builder: (context) {
      return Container(
        ...
        padding: const EdgeInsets.only(
            top: 12, left: 24, right: 24, bottom: 32),
        child: Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.stretch,
          children: [
...
Future<void> startVehicleReturnWorkflow(
  ...
  if (context.mounted) {
    ...
    final success =
        await context.read<AppProvider>().submitVehicleReturn(
              photos: photos,
        ...
        content: Column(
          ...
          children: [
            _IntentOption(
              ...
              onTap: () =>
                  _updateIntent(context, rider, 'Personal Use'),
            ),
            _IntentOption(
            ...
            _IntentOption(
              ...
              onTap: () =>
                  _updateIntent(context, rider, 'Food Delivery'),
            ),
            _IntentOption(
              label: 'Other',
...
void _updateIntent(
    BuildContext context, RiderModel rider, String newIntent) {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      leading: Icon(
        ...
        color: isSelected ? const Color(0xFF0053C1) : null,
      ),
      onTap: onTap,
    );
  }
