...
/// Ryd brand colour (`#0053c1`). When the user taps an option the
          ...
          builder: (context, child) {
            return Container(
              ...
              decoration: BoxDecoration(
                color: vfBlueLight.withOpacity(0.35),
                ...
                children: [
                  ...
                  Row(
                    children: List.generate(2, (index) {
                      ...
                      final textColor =
                          isSelected ? Colors.white : vfBlue.withOpacity(0.8);
