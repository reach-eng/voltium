...
class PerformanceService {
  ...
  void stopTrace(String name, {Map<String, dynamic>? attributes}) {
    ...
    // In a real production app, we would use local logs's performance monitoring:
    // final transaction = local logs.getSpan() ?? local logs.startTransaction(name, 'ui_load');
