...
void main() {
  ...
  testWidgets('Login screen – enter phone and navigate to OTP', (tester) async {
    ...
    final hasOtp = app.login.otpField.evaluate().isNotEmpty;
    final hasLegal = app.onboarding.acceptCheckbox.evaluate().isNotEmpty;
    final hasPermissions = find
        .byKey(const Key('continuePermissionsButton'))
        .evaluate()
        .isNotEmpty;
    final hasIntent = app.onboarding.deliverWithUsCard.evaluate().isNotEmpty;
