...
void main() {
  ...
  testWidgets('Vehicle return – initiate return from dashboard',
    ...
    final endRentalBtn = app.dashboard.endRentalButton;
    ...
    final hasReturnOption = endRentalBtn.evaluate().isNotEmpty ||
        app.dashboard.processReturnButton.evaluate().isNotEmpty ||
  ...
  testWidgets('Vehicle return – return pending state display', (tester) async {
    ...
    expect(
      find.textContaining('Return Pending').evaluate().isNotEmpty ||
          ...
          app.dashboard.dashboardTab.evaluate().isNotEmpty,
      isTrue,
  ...
  testWidgets(
    ...
    final manageSubBtn = app.shared.manageSubscriptionButton;
    ...
    if (manageSubBtn.evaluate().isNotEmpty) {
      ...
      final hasEndRentalKey =
          app.dashboard.endRentalButton.evaluate().isNotEmpty;
  ...
  testWidgets('Vehicle return – cancel return process', (tester) async {
    ...
    final cancelReturnBtn = app.dashboard.cancelReturnButton;
    final cancelProcessBtn = app.dashboard.cancelReturnProcessButton;
  ...
  testWidgets('Vehicle return – wallet settlement check', (tester) async {
    ...
    expect(
      hasSettlementTx || find.text('Wallet').evaluate().isNotEmpty,
      isTrue,
  ...
  testWidgets('Vehicle return – return photos UI elements', (tester) async {
    ...
    if (vehicleCard.evaluate().isNotEmpty) {
      ...
      expect(
        hasPhotoContent || vehicleCard.evaluate().isNotEmpty,
        isTrue,
