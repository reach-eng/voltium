...
import { 
  UserPlus, ShieldX, Lock, History,  Building, ShieldAlert, Users, Camera, Wallet, ShieldCheck, Smartphone, Bike, Unlock,   User, Phone, Mail, MapPin, Calendar, Clock, Shield, Star, Info,
  FileText, CheckCircle2, AlertCircle, XCircle, FileImage, FileCode,
  CreditCard, Briefcase, Activity, Zap, IndianRupee, Hash, RefreshCw, X, Download, Save, Pencil, Trash2
} from 'lucide-react';
...
export function RiderDetailModal({ 
  selectedRider, setSelectedRider, isEditing, setIsEditing, editForm, setEditForm, saving,
  handleUpdateRider, startEditing, setDeleteDocKey, setConfirmKycAction, setKycRejectionReason,
  setConfirmClearGuarantor, setConfirmDelete, setShowAdjustWallet, handleTlAction, getKycBadge, getStateBadge, DetailGroup,
  selectedKycDocs, toggleKycDoc, handleDeleteKycDoc, handleClearGuarantor, permissions, STATE_FILTERS, handleBulkDeleteKycDocs, setSelectedKycDocs
}: any) {
                  ...
                  >
                    ...
                    <div className="grid grid-cols-3 gap-6">
                      <DetailGroup
                        ...
                        isEditing={isEditing}
                        field="fullName"
                        onEdit={(v: any) => setEditForm({ ...editForm, fullName: v })}
                      />
                      <DetailGroup
                        label="Email Address"
                        ...
                        isEditing={isEditing}
                        field="email"
                        onEdit={(v: any) => setEditForm({ ...editForm, email: v })}
                      />
                      <DetailGroup
                        label="Phone Number"
                        ...
                        isEditing={isEditing}
                        field="phone"
                        onEdit={(v: any) => setEditForm({ ...editForm, phone: v })}
                      />
                      <DetailGroup
                        label="Father's Name"
                        ...
                        isEditing={isEditing}
                        field="fatherName"
                        onEdit={(v: any) => setEditForm({ ...editForm, fatherName: v })}
                      />
                      <DetailGroup
                        label="Mother's Name"
                        ...
                        isEditing={isEditing}
                        field="motherName"
                        onEdit={(v: any) => setEditForm({ ...editForm, motherName: v })}
                      />
                      <DetailGroup
                        label="Date of Birth"
                        ...
                        field="dob"
                        type="date"
                        onEdit={(v: any) => setEditForm({ ...editForm, dob: v })}
                      />
                      <DetailGroup
                        label="Intent"
                        ...
                        isEditing={isEditing}
                        field="intent"
                        onEdit={(v: any) => setEditForm({ ...editForm, intent: v })}
                      />
                      <DetailGroup
                        ...
                        onEdit={(v: any) => setEditForm({ ...editForm, emergencyContact: v })}
                      />
                      <DetailGroup
                        ...
                        onEdit={(v: any) => setEditForm({ ...editForm, lifecycleStatus: v })}
                      />
                    </div>
                    ...
                    <div className="p-8 rounded-3xl bg-blue-500/5 border border-blue-500/10">
                      ...
                      <div className="grid grid-cols-3 gap-6">
                        <DetailGroup
                          ...
                          isEditing={isEditing}
                          field="bankName"
                          onEdit={(v: any) => setEditForm({ ...editForm, bankName: v })}
                        />
                        <DetailGroup
                          ...
                          isEditing={isEditing}
                          field="accountNumber"
                          onEdit={(v: any) => setEditForm({ ...editForm, accountNumber: v })}
                        />
                        <DetailGroup
                          label="IFSC Code"
                          ...
                          isEditing={isEditing}
                          field="ifscCode"
                          onEdit={(v: any) => setEditForm({ ...editForm, ifscCode: v })}
                        />
                      </div>
                    </div>
                  </TabsContent>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <DetailGroup
                            ...
                            isEditing={isEditing}
                            field="guarantorName"
                            onEdit={(v: any) => setEditForm({ ...editForm, guarantorName: v })}
                          />
                          <DetailGroup
                            label="Phone Number"
                            value={
                            ...
                            onEdit={(v: any) => setEditForm({ ...editForm, guarantorPhone: v })}
                          />
                          <DetailGroup
                            label="Date of Birth"
                            ...
                            field="guarantorDob"
                            type="date"
                            onEdit={(v: any) => setEditForm({ ...editForm, guarantorDob: v })}
                          />
                          <DetailGroup
                            label="Father's Name"
                            value={
                            ...
                            onEdit={(v: any) => setEditForm({ ...editForm, guarantorFatherName: v })}
                          />
                          <DetailGroup
                            label="Mother's Name"
                            value={
                            ...
                            onEdit={(v: any) => setEditForm({ ...editForm, guarantorMotherName: v })}
                          />
                          <DetailGroup
                            label="Address"
                            value={
                            ...
                            onEdit={(v: any) => setEditForm({ ...editForm, guarantorAddress: v })}
                          />
                        </div>
                        <div className="pt-4">
                          <DetailGroup
                            ...
                            onEdit={(v: any) => setEditForm({ ...editForm, guarantorStatus: v })}
                          />
                        </div>
                      </div>
                      <div className="space-y-6">
                        ...
                        <div>
                          ...
                          {isEditing ? (
                            <Select
                              ...
                              onValueChange={(v: any) => setEditForm({ ...editForm, depositStatus: v })}
                            >
                      ...
                      <div className="p-8 rounded-3xl bg-muted/20 border space-y-6">
                        ...
                        <div className="space-y-4">
                          <DetailGroup
                            ...
                            isEditing={isEditing}
                            field="teamLeader"
                            onEdit={(v: any) => setEditForm({ ...editForm, teamLeader: v })}
                          />
                          <DetailGroup
                            ...
                            onEdit={(v: any) => setEditForm({ ...editForm, assignedTlName: v })}
                          />
                          <DetailGroup
                            ...
                            onEdit={(v: any) => setEditForm({ ...editForm, assignedTlPhone: v })}
                          />
                          <DetailGroup
                            label="Emergency Contact"
                            value={
                          ...
                          <DetailGroup
                            ...
                            isEditing={isEditing}
                            field="referredBy"
                            onEdit={(v: any) => setEditForm({ ...editForm, referredBy: v })}
                          />
                        </div>
                      </div>
                      <div className="p-8 rounded-3xl bg-muted/20 border space-y-6">
                        ...
                        <div className="space-y-4">
                          <DetailGroup
                            ...
                            isEditing={isEditing}
                            field="pickupHub"
                            onEdit={(v: any) => setEditForm({ ...editForm, pickupHub: v })}
                          />
                          <DetailGroup
                            ...
                            onEdit={(v: any) => setEditForm({ ...editForm, preferredShift: v })}
                          />
                          <DetailGroup
                            ...
                            isEditing={isEditing}
                            field="deliveryId"
                            onEdit={(v: any) => setEditForm({ ...editForm, deliveryId: v })}
                          />
                          <DetailGroup
                            label="User Intent"
                            value={isEditing ? editForm.intent : selectedRider.intent}
                          ...
                          <DetailGroup
                            ...
                            isEditing={isEditing}
                            field="activeVehicle"
                            onEdit={(v: any) => setEditForm({ ...editForm, activeVehicle: v })}
                          />
                          <DetailGroup
                            label="Vehicle Model"
                            value={
                            ...
                            onEdit={(v: any) => setEditForm({ ...editForm, activeVehicleModel: v })}
                          />
                        </div>
                      </div>
                    </div>
