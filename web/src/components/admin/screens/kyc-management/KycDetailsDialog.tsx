...
import { kycDocuments } from './kyc-types';
...
export function KycDetailsDialog({ selectedRider, onClose }: KycDetailsDialogProps) {
  return (
    <Dialog open={!!selectedRider} onOpenChange={onClose}>
