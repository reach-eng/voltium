          ...
          <div className="space-y-4">
            ...
            <div className="bg-muted/50 rounded-lg p-4 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                <div>
                  <span className="text-muted-foreground">Name:</span> {ticket.riderName}
                </div>
                <div>
                  <span className="text-muted-foreground">Phone:</span> {ticket.riderPhone}
                </div>
                <div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex justify-end">
                  <Button
                    ...
                    disabled={
                      replyLoading || !replyMessage.trim() || ticket.status === 'CLOSED'
                    }
                  >
                    {replyLoading ? (
                      <>
