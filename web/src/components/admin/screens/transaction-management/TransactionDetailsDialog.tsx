...
export function TransactionDetailsDialog({
  ...
  const { badgeColor, amountColor, statusBadgeColor, isCredit } =
    getTransactionColors(transaction);
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-sm font-mono">{transaction.id.substring(0, 12)}...</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm font-medium">
                {transaction.rider?.fullName || transaction.rider?.name || 'Unknown'}
              </p>
