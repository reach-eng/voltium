...
import type { Transaction, TransactionColors } from './types';
...
export function getTransactionColors(tx: Transaction): TransactionColors {
  ...
  if (status === 'REJECTED' || status === 'FAILED') {
    ...
    if (purpose.includes('REWARD')) {
      badgeColor =
        'border-orange-500/20 text-orange-600 bg-orange-500/5 dark:text-orange-400';
