 ...
 *
 * Mapping from jobId → outbox event type defined in job-outbox-config.ts.
 */
import { JOB_TO_OUTBOX_CONFIG, type JobOutboxConfig } from '@/server/workers/job-outbox-config';
