...
async function main() {
  ...
  const kycProfiles = [
    ...
    },
    {
      ...
      panNumber: 'JKLMN1234P',
      bankName: 'Kotak',
      accountNumber: '2233445566',
      ifscCode: 'KKBK0001234',
      profilePhoto: 'https://placehold.co/400x400/ea580c/white?text=Neha+Singh',
      aadhaarFront: 'https://placehold.co/600x400/f3f4f6/191c1e?text=Aadhaar+Front',
      aadhaarBack: 'https://placehold.co/600x400/f3f4f6/191c1e?text=Aadhaar+Back',
      panCard: 'https://placehold.co/600x400/f3f4f6/191c1e?text=PAN+Card',
      signature: 'https://placehold.co/400x200/ffffff/000000?text=Neha+Sig',
    },
    {
      riderId: 'rider-5',
      status: 'SUBMITTED',
      aadhaarNumber: '888899990000',
      panNumber: 'WXYZP1234A',
      bankName: 'PNB',
      accountNumber: '3344556677',
      ifscCode: 'PUNB0001234',
      profilePhoto: 'https://placehold.co/400x400/9333ea/white?text=Deepak+Verma',
      aadhaarFront: 'https://placehold.co/600x400/f3f4f6/191c1e?text=Aadhaar+Front',
      aadhaarBack: 'https://placehold.co/600x400/f3f4f6/191c1e?text=Aadhaar+Back',
      panCard: 'https://placehold.co/600x400/f3f4f6/191c1e?text=PAN+Card',
      signature: 'https://placehold.co/400x200/ffffff/000000?text=Deepak+Sig',
    },
  ];
  ...
  const wallets = [
    {
      ...
      securityDepositInPaise: paise(5000),
  ...
  for (const c of coupons) {
    ...
    await db.coupon.upsert({
      ...
      create: {
        ...
        discountValueInPaise: isFixed ? paise(c.discountValue) : c.discountValue,
  ...
  // idempotent.
  //
  // LEGAL-AUDIT-P1-2-2026-09-10: content is now plain text — the
  // admin schema strips Markdown at save time so riders never see
  // literal `#` / `**`. The seed was the original source of Markdown
  // contamination. Stubs for rental_safety and guarantor remain —
  // the legal team fills in the real policy text.
  const legalDocs = [
    {
      type: 'terms',
      locale: 'en',
